...
public class TinaControllerParameter {
  ...
  public JCheckBox pBinaryTransparencyCBx;
  public JCheckBox pInvertColorCBx;
  public JCheckBox pInvertBrightnessCBx;
  ...
  public JWFNumberField luminosityThreshField;
  public JSlider luminosityThreshSlider;
  ...
  public void setParams1(TinaInternalFrame pTinaFrame, ErrorHandler pErrorHandler, Prefs pPrefs, JPanel pCenterPanel, JWFNumberField pCameraRollREd, JSlider pCameraRollSlider, JWFNumberField pCameraPitchREd, JSlider pCameraPitchSlider, JWFNumberField pCameraYawREd, JSlider pCameraYawSlider, JWFNumberField pCameraPerspectiveREd, JSlider pCameraPerspectiveSlider, JWFNumberField pCameraCentreXREd, JSlider pCameraCentreXSlider, JWFNumberField pCameraCentreYREd, JSlider pCameraCentreYSlider, JWFNumberField pCameraZoomREd, JSlider pCameraZoomSlider, JCheckBox pNewDOFCBx, JWFNumberField pFocusXREd, JSlider pFocusXSlider, JWFNumberField pFocusYREd, JSlider pFocusYSlider, JWFNumberField pFocusZREd, JSlider pFocusZSlider, JWFNumberField pDimishZREd, JSlider pDimishZSlider,
      ...
      JWFNumberField pGammaThresholdREd, JSlider pGammaThresholdSlider, 
      JCheckBox pBGTransparencyCBx, JCheckBox paramBinaryTransparencyCBx, JCheckBox paramInvertColorCBx, JCheckBox paramInvertBrightnessCBx, 
      JWFNumberField paramLuminosityThreshField, JSlider paramLuminosityThreshSlider,
      JTextField pPaletteRandomPointsREd, JPanel pPaletteImgPanel, JPanel pColorChooserPaletteImgPanel, JWFNumberField pPaletteShiftREd, JSlider pPaletteShiftSlider, JWFNumberField pPaletteRedREd, JSlider pPaletteRedSlider, JWFNumberField pPaletteGreenREd, JSlider pPaletteGreenSlider, JWFNumberField pPaletteBlueREd, JSlider pPaletteBlueSlider, JWFNumberField pPaletteHueREd, JSlider pPaletteHueSlider,
    ...
    this.pBinaryTransparencyCBx = paramBinaryTransparencyCBx;
    this.pInvertColorCBx = paramInvertColorCBx;
    this.pInvertBrightnessCBx = paramInvertBrightnessCBx;
    
    this.luminosityThreshField = paramLuminosityThreshField;
    this.luminosityThreshSlider = paramLuminosityThreshSlider;
  ...
  public void setParams3(JButton pMeshGenFromEditorBtn, JButton pMeshGenFromClipboardBtn, JButton pMeshGenLoadFlameBtn,
      ...
      JWFNumberField pLogDensityBaseField, JSlider pLogDensityBaseSlider,
    ...
    logDensityBaseField = pLogDensityBaseField;
    logDensityBaseSlider = pLogDensityBaseSlider;
