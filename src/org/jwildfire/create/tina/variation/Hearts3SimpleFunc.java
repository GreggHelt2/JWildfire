...
/**
 *  Hearts3 variation function
*/
public class Hearts3SimpleFunc extends VariationFunc {
  private static final long serialVersionUID = 1L;

  private static final String PARAM_A = "a";  // = a_radius + b_radius + c_radius
  private static final String PARAM_B = "b";  // = a_radius/b_radius 
  private static final String PARAM_C = "c";  //  = (c_radius/b_radius) - 1
...
// HEARTS3
      ...
      double pvar = 1;
      double r = 2 - (b * 2 * sin(theta)) + (sin(theta) * pow(abs(cos(c * theta)), (pvar/2)) / (sin(theta) + (a *1.4)));
